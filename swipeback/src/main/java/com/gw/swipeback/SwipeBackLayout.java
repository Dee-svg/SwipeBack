...
import static com.gw.swipeback.SwipeBackLayout.DirectionMode.FROM_LEFT;
import static com.gw.swipeback.SwipeBackLayout.DirectionMode.FROM_TOP;
import static com.gw.swipeback.SwipeBackLayout.DirectionMode.FROM_RIGHT;
import static com.gw.swipeback.SwipeBackLayout.DirectionMode.FROM_BOTTOM;
...
public class SwipeBackLayout extends ViewGroup {
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View child, int pointerId) {
            return !ignoreDragEvent &&child == mDragContentView;
        }
    ...
    private boolean isSwipeFromEdgeEnabled() {
        if (isSwipeFromEdge) {
            switch (mDirectionMode) {
                case FROM_LEFT:
    ...
    public void ignoreDragEvent(boolean ignore) {
        ...
        if(getChildCount() > 0) {
            smoothScrollToStart(getChildAt(0),(int) mOriginPoint.x, (int) mOriginPoint.y);
        }
    }
     ...
     * @param y 垂直坐标
     */
    public void smoothScrollToStart(View view, int x, int y) {
        if(null != view) {
            mDragHelper.smoothSlideViewTo(view, x, y);
            invalidate();
        }
    }
